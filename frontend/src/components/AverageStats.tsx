...
export function AverageStats() {
  ...
  // Ключ SWR теперь включает currency, так что при смене UAH на USD
  // SWR поймет, что старые цифры не годятся и сделает новый запрос
    ...
    <div className="mt-2 flex items-center justify-between rounded-3xl border border-gray-100 bg-white/50 p-4 px-6 dark:border-slate-800 dark:bg-slate-900/50 shadow-sm transition-all">
      <div className="flex gap-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[9px] font-black uppercase tracking-tighter text-gray-400 dark:text-slate-500">Средний расход</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[9px] font-black uppercase tracking-tighter text-gray-400 dark:text-slate-500">Средний доход</p>
